 ...
 * @Purpose : Stock management using Stack Linked list.
 */
public class StockAccountUsingStackList {
	public static void main(String[] args) {
								...
								case 1:
									...
									if (custoshare < companyList.get(indexOfCompany).getNumberOfShare()) {
										...
										if (customerList.get(indexOfCustomer).getAmountOfCustomer() > amountvalue) {
											...
											queueList.slist.push(new Transaction(transactid, buyerName, sellerName,
		...
		while (!queueList.slist.isempty()) {
			tra = queueList.slist.pop();
